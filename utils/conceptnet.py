...
inverse_rels = {
    'is an antonym of':     'is an antonym of',
    'is located at':         'is the location of',
    'is capable of':         'has the capability of' ,  # or "cannot"
    'causes':                'is caused by',
    'is created by':         'creates',
    'is a kind of':          'has instances like',
    'desires':               'is desired by',
    'has sub-event':         'is a sub-event of',
    'is part of':            'has part',
    'has context':           'is in the context of',
    'has property':          'is a property of',
    'is made of':            'makes up',
    'is not capable of':     'cannot be done by',     # invert of invert
    'does not desire':       'is not desired by',
    'receives an action':    'acts on',
    'is related to':         'is related to',
    'is used for':           'is used by',
}
