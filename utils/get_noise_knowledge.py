...
def load_cpnet(path: str):
    ...
    if not isinstance(cpnet, (nx.MultiDiGraph, nx.MultiGraph)):
        # safety: ensure MultiDiGraph semantics for edge data access
...
def main():
    ...
    with open(args.subgraphs_p_k := args.subgraphs_pk, 'rb') as f:
