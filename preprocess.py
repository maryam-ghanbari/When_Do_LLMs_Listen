...
input_paths = {
    'csqa': {
        ...
        'dev': '/content/KGSweetSpot/data/csqa/dev_rand_split.jsonl',
...
output_paths = {
    'cpnet': {
        'csv': '/content/KGSweetSpot/data/cpnet/conceptnet.en.csv',
        'vocab': '/content/KGSweetSpot/data/cpnet/concept.txt',
        'patterns': '/content/KGSweetSpot/data/cpnet/matcher_patterns.json',
        'unpruned-graph': '/content/KGSweetSpot/data/cpnet/conceptnet.en.unpruned.graph',
        'pruned-graph': '/content/KGSweetSpot/data/cpnet/conceptnet.en.pruned.graph',
    },
    'csqa': {
        'statement': {
            'train': '/content/KGSweetSpot/data/csqa/statement/train.statement.jsonl',
            'dev': '/content/KGSweetSpot/data/csqa/statement/dev.statement.jsonl',
            'test': '/content/KGSweetSpot/data/csqa/statement/test.statement.jsonl',
        },
        'grounded': {
            'train': './data/csqa/grounded/train.grounded.jsonl',
            'dev': '/content/KGSweetSpot/data/csqa/grounded/dev.grounded.jsonl',
            'test': './data/csqa/grounded/test.grounded.jsonl',
        },
        'graph': {
            'adj-train': './data/csqa/graph/train.graph.adj.pk',
            'adj-dev': '/content/KGSweetSpot/data/csqa/graph/dev.graph.adj.pk',
